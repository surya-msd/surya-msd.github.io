...
export default class Boats extends LightningElement {
    ...
    displayInfo = {
        primaryField: 'Name', // "boat name" is assumed to be the standard 'Name' field
        additionalFields: ['BoatType__r.Name'], // Displays the Type from a related object
    };

    // Configures the searchable fields for the picker
    matchingInfo = {
    ...
    handleChange(event) {
        // The event detail contains the ID of the newly selected record
